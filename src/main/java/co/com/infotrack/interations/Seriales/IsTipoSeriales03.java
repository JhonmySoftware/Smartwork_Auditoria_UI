...
import co.com.infotrack.interations.CantidadConteos.ObtenerCantidadConteos;
...
public class IsTipoSeriales03 implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        // Obtener la cantidad de los conteos
        //actor.attemptsTo(ObtenerCantidadConteos.one());
