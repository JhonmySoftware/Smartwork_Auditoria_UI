...
public class inputsListaCantidad implements Interaction {

    public static inputsListaCantidad one() {
        return Instrumented.instanceOf(inputsListaCantidad.class).withProperties();
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        // Obtener el texto de para gestionar la auditoria, se recurre a esto debido al man comportamiento del front-end
//        List<String> Auditoria = Collections.singletonList(ObGestionarAuditoria.TextoAuditoria
//                .resolveFor(actor).getText());
//        String TextoAuditoria = Auditoria.get(0);
//        System.out.println("Texto es: " + Auditoria.size());
//        System.out.println("Texto es: " + Auditoria.get(0));
