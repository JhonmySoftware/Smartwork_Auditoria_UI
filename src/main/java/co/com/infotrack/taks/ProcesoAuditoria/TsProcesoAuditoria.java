package co.com.infotrack.taks.ProcesoAuditoria;

import co.com.infotrack.interations.CrearAuditorias.IsCrearAuditoria01;
import co.com.infotrack.interations.GestionarAuditoria.IsGestionarAuditoria02;
...
public class TsProcesoAuditoria implements Task {

    public static TsProcesoAuditoria one() {
        return Tasks.instrumented(TsProcesoAuditoria.class);
    }
